...
import {
  ...
  TextIcon,
  TriangleDashedIcon,
  // TypeIcon, // Commented out - wordmark functionality removed
  // RssIcon, // Commented out - not used in command menu
} from "lucide-react";
...
// import { getWordmarkSVG } from "./chanhdai-wordmark"; // Keeping for potential future use
...
const DEBFOLIO_LINKS: CommandLinkItem[] = [
  {
    title: "About",
    href: "/#about",
    icon: LetterTextIcon,
      ...
      <CommandDialog open={open} onOpenChange={setOpen}>
        ...
        <CommandList className="min-h-80">
          ...
          <CommandGroup heading="Brand Assets">
            ...
            {/* Wordmark functionality removed - keeping for potential future use */}
            {/* <CommandItem
              onSelect={() => {
                handleCopyText(
            ...
            <CommandItem
              onSelect={() => handleOpenLink("/blog/brand")}
            >
              <TriangleDashedIcon />
              Brand Guidelines
            </CommandItem>
